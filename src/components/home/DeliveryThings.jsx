...
const DeliveryThings = () => {
  return (
    <Container>
      ...
      <div className="min-h-[200px] grid grid-cols-2 lg:grid-cols-5 items-center gap-x-4 gap-y-3 lg:gap-4 mt-8">
        <div className="min-h-[100px] border-2 dark:border-none border-gray-100 shadow-sm transition-all duration-300 rounded-md border-b-[3.2px]  hover:ease-linear hover:border-b-primary px-6 py-2.5 flex justify-center flex-col items-center gap-2">
        ...
        <div className="min-h-[100px] border dark:border-none border-gray-100 shadow-sm transition-all duration-300 rounded-md border-b-[3.2px] hover:ease-linear hover:border-b-primary px-6  py-2.5 flex justify-center flex-col items-center gap-2">
        ...
        <div className="col-span-2 lg:col-span-1 min-h-[100px] border dark:border-none border-gray-100 shadow-sm transition-all duration-300 rounded-md border-b-[3.2px] hover:ease-linear hover:border-b-primary px-6  py-2.5 flex justify-center flex-col items-center gap-2">
